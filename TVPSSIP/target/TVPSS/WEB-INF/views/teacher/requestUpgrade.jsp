...
<head>
    ...
    <title>Request TVPSS Upgrade</title>
    <style>
        body {
    ...
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/teacher/submitUpgradeRequest" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" id="schoolName" name="schoolName" value="${schoolName}" readonly>
            </div>
            <!-- Current Version -->
            <div class="form-group">
                <label for="version">Upgrade To Version:</label>
                <input type="text" id="version" name="version" value="${currentVersion}" readonly>
            </div>
            <!-- Submit Button -->
            <div class="form-group">
