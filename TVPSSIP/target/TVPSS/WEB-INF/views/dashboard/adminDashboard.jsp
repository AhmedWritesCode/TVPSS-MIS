...
<body>
    ...
    <div class="content">
        ...
        <div class="card">
            ...
            <p class="info-text">Below are the reports related to the TVPSS program that the PSS Management Team can view and manage:</p>
            <table>
                <thead>
                    <tr>
                        <th>Program ID</th>
